            ...
            <div className="">
                <Link to={`../books/${this.props.data.key.substring(7)}`} className="group">
                    <div className="displaySubject" >
                        <div className='flex justify-center items-center overflow-hidden object-cover h-60 w-full mb-3 bg-stone-100 px-8 py-8'>
                ...
                <button className='btn-sublte mt-4' onClick={() => { this.props.removeFromReadingList(this.props.dataBaseKey) }}>Remove</button>
            </div>
        )
    }
}
